...
namespace negocio
{
    public class ArticuloNegocio
    {
        ...
        public List<Articulo> listar()
        {
            ...
            try
            {
                datos.setearQuery("Select a.Id, a.Descripcion, ImagenUrl, Codigo, IdCategoria, c.Descripcion as Categoria, IdMarca, m.Descripcion as Marca, Nombre, a.descripcion, Precio From ARTICULOS A, CATEGORIAS C, MARCAS M Where IdMarca = m.Id and IdCategoria = c.Id");
        ...
        public List<Articulo> filtrar(string campo, string criterio, string filtro)
        {
            ...
            try
            {
                string consulta = "Select a.Id, a.Descripcion, ImagenUrl, Codigo, IdCategoria, c.Descripcion as Categoria, IdMarca, m.Descripcion as Marca, Nombre, a.descripcion, Precio From ARTICULOS A, CATEGORIAS C, MARCAS M Where IdMarca = m.Id and IdCategoria = c.Id And ";
                switch (campo)
                {
                    case "Código":
                        switch (criterio)
